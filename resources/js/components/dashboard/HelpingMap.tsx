...
class HelpingMap extends Component<IHelpingMapProps, IHelpingMapState> {
    ...
    render() {
        ...
        const jobMarkers = this.props.jobs.map((job) =>
            <Marker key={job.id} position={[job.latitude, job.longitude]} icon={new L.Icon({ iconUrl: 'https://img.icons8.com/flat_round/344/hand.png', iconSize: new L.Point(60, 60), className: 'grow' })}>
                <Popup>
